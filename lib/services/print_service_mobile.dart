import 'package:flutter_bluetooth_serial_plus/flutter_bluetooth_serial.dart'; // <- THIS IS THE ONLY IMPORT
...
class PrintService {
  ...
  Future<void> printReceipt(List<Map<String, dynamic>> cart, double total) async {
    ...
    var connection = await BluetoothConnection.toAddress(printer.address);
    ...
    for(var item in cart){
      bytes += generator.row([
        PosColumn(text: item['name'].toString(), width: 4),
